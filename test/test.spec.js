...
require('http');
const sicinfoMiddleware = require('sicinfo-middleware');
...
const NODE_ENV = 'test';
const _m = sicinfoMiddleware.middleware({ 
  host,
  NODE_PORT, 
  NODE_ENV, 
  dist: `${PWD}/test/dist` 
...
before(() => _m.server.listen(NODE_PORT, host, sicinfoMiddleware.listen(_m)));
